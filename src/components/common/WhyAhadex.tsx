          ...
          <Reveal delay={0.08} direction="up">
            <TiltCard maxTilt={3.5} className="h-full w-full">
              <div className="relative p-[1.5px] rounded-2xl overflow-hidden group h-full w-full shadow-lg transition-all duration-300">
                ...
                <div className="relative flex flex-col justify-between h-full rounded-[14.5px] p-6 bg-slate-900/95 hover:bg-slate-900/98 transition-all duration-300 overflow-hidden">
                  <div>
                    ...
                    <h3 className="text-lg font-bold text-slate-100 group-hover:text-cyan-200 transition-colors">
                      Private Processing
                    </h3>
              ...
              <div className="relative p-[1.5px] rounded-2xl overflow-hidden group h-full w-full shadow-lg transition-all duration-300">
                ...
                <div className="relative flex flex-col justify-between h-full rounded-[14.5px] p-6 bg-slate-900/95 hover:bg-slate-900/98 transition-all duration-300 overflow-hidden">
                  <div>
                    ...
                    <h3 className="text-lg font-bold text-slate-100 group-hover:text-blue-200 transition-colors">
                      Fast Processing
                    </h3>
                    <p className="text-xs sm:text-sm text-slate-400 mt-1.5 leading-relaxed">
              ...
              <div className="relative p-[1.5px] rounded-2xl overflow-hidden group h-full w-full shadow-lg transition-all duration-300">
                ...
                <div className="relative flex flex-col justify-between h-full rounded-[14.5px] p-6 bg-slate-900/95 hover:bg-slate-900/98 transition-all duration-300 overflow-hidden">
                  <div>
                    ...
                    <h3 className="text-lg font-bold text-slate-100 group-hover:text-emerald-200 transition-colors">
                      Easy to Use
                    </h3>
                    <p className="text-xs sm:text-sm text-slate-400 mt-1.5 leading-relaxed">
